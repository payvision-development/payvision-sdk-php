...
use Payvision\SDK\Domain\Checkouts\ValueObject\Checkout\RequestOption as RequestOptionObject;
...
class RequestOption extends Basic
{
     ...
     * @return RequestOption
     */
    public function setNoShipping(string $noShipping): RequestOption
    {
