...
namespace Payvision\SDK\Domain\Paymentlink\Service\Builder;

use Payvision\SDK\Domain\Paymentlink\ValueObject\BasicResponseHeader as BasicResponseHeaderObject;
