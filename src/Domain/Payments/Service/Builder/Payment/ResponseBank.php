...
use Payvision\SDK\Domain\Payments\ValueObject\Payment\ResponseBank as ResponseBankObject;
...
class ResponseBank extends Basic
{
     ...
     * @return ResponseBank
     */
    public function setAccountNumber(string $accountNumber): ResponseBank
    {
